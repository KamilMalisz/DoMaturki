...
const Faq = () => {
  /* const items = [ 
    {
      title: "Jakie oferty znajdę na portalu?",
      content:
        "Na portalu znajdziesz szeroką gamę ofert nieruchomości na sprzedaż i wynajem, w tym mieszkania, domy, działki, lokale użytkowe, garaże oraz hale i magazyny.",
    },
    {
